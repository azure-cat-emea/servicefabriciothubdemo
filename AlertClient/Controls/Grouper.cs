...
namespace Microsoft.AzureCat.Samples.AlertClient
{
    ...
    public class Grouper : UserControl
    {
        ...
        {
            this.PaintBack(e.Graphics);
            this.PaintGroupText(e.Graphics);
        ...
        {
            get { return this.V_BackColor; }
            set
            {
                this.V_BackColor = value;
                this.Refresh();
            }
        }
        ...
        {
            get { return this.V_CustomGroupBoxColor; }
            set
            {
                this.V_CustomGroupBoxColor = value;
                this.Refresh();
            }
        }
        ...
        {
            get { return this.V_PaintGroupBox; }
            set
            {
                this.V_PaintGroupBox = value;
                this.Refresh();
            }
        }
        ...
        {
            get { return this.V_GroupImage; }
            set
            {
                this.V_GroupImage = value;
                this.Refresh();
            }
        }
        ...
        {
            get { return this.V_ShadowColor; }
            set
            {
                this.V_ShadowColor = value;
                this.Refresh();
            }
        }
        ...
        {
            get { return this.V_ShadowThickness; }
            set
            {
                if (value > 10)
                {
                    this.V_ShadowThickness = 10;
                }
                else
                {
                    if (value < 1)
                    {
                        this.V_ShadowThickness = 1;
                    }
                    else
                    {
                        this.V_ShadowThickness = value;
                    }
                }
        ...
        {
            get { return this.V_BackgroundColor; }
            set
            {
                this.V_BackgroundColor = value;
                this.Refresh();
            }
        }
        ...
        {
            get { return this.V_BackgroundGradientColor; }
            set
            {
                this.V_BackgroundGradientColor = value;
                this.Refresh();
            }
        }
        ...
        {
            get { return this.V_BackgroundGradientMode; }
            set
            {
                this.V_BackgroundGradientMode = value;
                this.Refresh();
            }
        }
        ...
        {
            get { return this.V_RoundCorners; }
            set
            {
                if (value > 25)
                {
                    this.V_RoundCorners = 25;
                }
                else
                {
                    if (value < 1)
                    {
                        this.V_RoundCorners = 1;
                    }
                    else
                    {
                        this.V_RoundCorners = value;
                    }
                }
        ...
        {
            get { return this.V_GroupTitle; }
            set
            {
                this.V_GroupTitle = value;
                this.Refresh();
            }
        }
        ...
        {
            get { return this.V_BorderColor; }
            set
            {
                this.V_BorderColor = value;
                this.Refresh();
            }
        }
        ...
        {
            get { return this.V_BorderThickness; }
            set
            {
                if (value > 3)
                {
                    this.V_BorderThickness = 3;
                }
                else
                {
                    if (value < 1)
                    {
                        this.V_BorderThickness = 1;
                    }
                    else
                    {
                        this.V_BorderThickness = value;
                    }
                }
                this.Refresh();
            }
        ...
        {
            get { return this.V_ShadowControl; }
            set
            {
                this.V_ShadowControl = value;
                this.Refresh();
            }
        }
        ...
        private void InitializeGroupBox()
        {
            ...
            this.Resize += new EventHandler(this.GroupBox_Resize);
